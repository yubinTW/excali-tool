...
export const mulScalar = (a: NVector, b: NVector): number => b[0] * a[0] + b[2] * a[2] + b[3] * a[3] - b[6] * a[6]
...
export const norm = (a: NVector): number => Math.sqrt(Math.abs(a[0] * a[0] - a[2] * a[2] - a[3] * a[3] + a[6] * a[6]))

export const inorm = (a: NVector): number => Math.sqrt(Math.abs(a[7] * a[7] - a[5] * a[5] - a[4] * a[4] + a[1] * a[1]))
