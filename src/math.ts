...
export const getControlPointsForBezierCurve = (element: NonDeleted<ExcalidrawLinearElement>, endPoint: Point) => {
...
export const rangeIntersection = (rangeA: [number, number], rangeB: [number, number]): [number, number] | null => {
