...
export const exportToCanvas = async (
  ...
  renderStaticScene({
    ...
    allElementsMap: toBrandedType<NonDeletedSceneElementsMap>(arrayToMap(syncInvalidIndices(elements))),
...
export const exportToSvg = async (
  ...
  /** Yubin: disable darkMode */
  // if (exportWithDarkMode) {
  //   svgRoot.setAttribute("filter", THEME_FILTER);
  // }

  /** Yubin: comment assetPath setting */
