...
import { ExcalidrawElement, FractionalIndex, OrderedExcalidrawElement } from './element/types'
 ...
 */
export const validateFractionalIndices = (indices: (ExcalidrawElement['index'] | undefined)[]) => {
 ...
 */
export const syncInvalidIndices = (elements: readonly ExcalidrawElement[]): OrderedExcalidrawElement[] => {
