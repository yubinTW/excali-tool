...
/** Yubin: set 1 */
const defaultExportScale = 1 // EXPORT_SCALES.includes(devicePixelRatio) ? devicePixelRatio : 1
...
export const isEraserActive = ({ activeTool }: { activeTool: AppState['activeTool'] }) => activeTool.type === 'eraser'
