...
const chartTypeBar = (spreadsheet: Spreadsheet, x: number, y: number): ChartElements => {
  ...
  return [...bars, ...chartBaseElements(spreadsheet, x, y, groupId, backgroundColor)]
}
...
const chartTypeLine = (spreadsheet: Spreadsheet, x: number, y: number): ChartElements => {
  ...
  return [...chartBaseElements(spreadsheet, x, y, groupId, backgroundColor), line, ...lines, ...dots]
}

export const renderSpreadsheet = (chartType: string, spreadsheet: Spreadsheet, x: number, y: number): ChartElements => {
  if (chartType === 'line') {
