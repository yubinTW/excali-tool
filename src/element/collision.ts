...
export const isPointHittingElementBoundingBox = (
  ...
  return (
    rotatedX > x1 - threshold && rotatedX < x2 + threshold && rotatedY > y1 - threshold && rotatedY < y2 + threshold
  )
}
...
const hitTestFreeDrawElement = (element: ExcalidrawFreeDrawElement, point: Point, threshold: number): boolean => {
...
const pointInBezierEquation = (p0: Point, p1: Point, p2: Point, p3: Point, [mx, my]: Point, lineThreshold: number) => {
