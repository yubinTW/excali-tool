...
export const isMagicFrameElement = (element: ExcalidrawElement | null): element is ExcalidrawMagicFrameElement => {
  return element != null && element.type === 'magicframe'
}

export const isFrameLikeElement = (element: ExcalidrawElement | null): element is ExcalidrawFrameLikeElement => {
  return element != null && (element.type === 'frame' || element.type === 'magicframe')
}

export const isFreeDrawElement = (element?: ExcalidrawElement | null): element is ExcalidrawFreeDrawElement => {
...
export const isUsingProportionalRadius = (type: string) => type === 'line' || type === 'arrow' || type === 'diamond'
