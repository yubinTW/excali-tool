...
export class ElementBounds {
  ...
  static getBounds(element: ExcalidrawElement) {
    ...
    const bounds = ElementBounds.calculateBounds(element, scene?.getNonDeletedElementsMap() || new Map())
...
export const getElementAbsoluteCoords = (
  ...
  const elementsMap = Scene.getScene(element)?.getElementsMapIncludingDeleted() || new Map()
  if (isFreeDrawElement(element)) {
