...
import { ExportedDataState, ExportedLibraryData, ImportedDataState, ImportedLibraryData } from './types'
...
// export const loadFromJSON = async (localAppState: AppState, localElements: readonly ExcalidrawElement[] | null) => {
