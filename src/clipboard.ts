...
type ParsedClipboardEvent = { type: 'text'; value: string } | { type: 'mixedContent'; value: PastedMixedContent }
 ...
 */
const parseClipboardEvent = async (event: ClipboardEvent, isPlainPaste = false): Promise<ParsedClipboardEvent> => {
  try {
